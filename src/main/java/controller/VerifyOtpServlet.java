...
public class VerifyOtpServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Lấy mã OTP từ session và mã người dùng nhập từ request
        String sessionOtp = String.valueOf(session.getAttribute("verificationCode"));
        String inputOtp = request.getParameter("otp");
        
        System.out.println("Session OTP: " + sessionOtp);
        System.out.println("Input OTP: " + inputOtp);

        // So sánh mã OTP từ session và mã OTP từ người dùng
        boolean isOtpValid = sessionOtp.equals(inputOtp);
