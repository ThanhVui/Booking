...
//        processRequest(request, response);
        ...
        ReviewHotelDAO reviewHotelDao = new ReviewHotelDAO(); // Tạo đối tượng ReviewHotelDao
        
        System.out.println("reviewHotelDao: " + reviewId);

        reviewHotelDao.deleteReview(Integer.parseInt(reviewId)); // Gọi phương thức deleteReview
